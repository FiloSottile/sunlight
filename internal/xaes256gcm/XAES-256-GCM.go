// Package xaes256gcm implements the XAES-256-GCM AEAD construction, as
// described in https://c2sp.org/XAES-256-GCM@v1.0.1.
//
// It is an AEAD with nonces wide enough to be safely randomly generated.
// The nonce must be uniformly random.
package xaes256gcm
